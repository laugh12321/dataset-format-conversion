...
class Loader:
    ...
    def __get_categories(self) -> dict:
        ...
        """
        __categories = [
            "vehicle", "pedestrian", "cyclist", "tricyclist", "motorcyclist", "barrowlist"
        ]
...
class DAIR2COCO(Loader):
    ...
    def format2coco(self, data_info: dict, json_path: str) -> None:
        ...
        for data in tqdm(data_info):
            ...
            image_dict = {"file_name": file_name, "height": 1080, "width": 1920, "id": img_id}
...
def parse_args():
    parser = argparse.ArgumentParser(description="DAIR-V2X dataset to PP-vehicle format.")
